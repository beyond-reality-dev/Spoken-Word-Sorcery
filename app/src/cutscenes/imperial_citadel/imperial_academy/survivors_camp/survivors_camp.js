...
async function survivorsCamp() {
  printLines("app/src/cutscenes/imperial_citadel/imperial_academy/survivors_camp/1.txt");
  ...
  printLines("app/src/cutscenes/imperial_citadel/imperial_academy/survivors_camp/2.txt");
  var response = await requireAnswer(
    ["yes", "y", "no", "n"],
    "Do you tell them about the Codex?"
  );
  if (response == "yes" || response == "y") {
    printLines("app/src/cutscenes/imperial_citadel/imperial_academy/survivors_camp/3.txt");
  } else if (response == "no" || response == "n") {
    printLines("app/src/cutscenes/imperial_citadel/imperial_academy/survivors_camp/4.txt");
  }
  changeValue(
